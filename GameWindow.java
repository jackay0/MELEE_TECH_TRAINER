...
*/
		// INITIALIZE SOUND MAP
				 ...
				 sounds.put("B", new File("./Notes/B.wav"));
				 sounds.put("C", new File("./Notes/C.wav"));
				 sounds.put("CSharp", new File("./Notes/CSharp.wav"));
				 sounds.put("D", new File("./Notes/D.wav"));
				 sounds.put("DSharp", new File("./Notes/DSharp.wav"));
				 sounds.put("E", new File("./Notes/E.wav"));
				 sounds.put("F", new File("./Notes/F.wav"));
				 sounds.put("FSharp", new File("./Notes/FSharp.wav"));
				 sounds.put("G", new File("./Notes/G.wav"));
				 sounds.put("GSharp", new File("./Notes/GSharp.wav"));
	}
