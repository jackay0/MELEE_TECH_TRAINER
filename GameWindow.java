...
public class GameWindow extends Canvas implements Runnable { // This interface is useful when utilizing multiple threads
	...
	public void delayFalling() {
		...
		// FOX MULTISHINE
		if (multi.isSelected()) {
			if (BnoteMS.getFalling() == false && XnoteMS.getFalling() == false && stickDownnoteMS.getFalling() == false && stickDownnoteMS2.getFalling() == false && stickDownnoteMS3.getFalling() == false) {
